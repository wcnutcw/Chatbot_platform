...
def analyze_question(question, context_p, data_json):
    ...
    **คำแนะนำในการตอบกลับ**:
    ...
    - ไม่ต้องแสดงความคิดเห็นใดๆ
    - เอาแค่คำตอบที่เกี่ยวข้องมากที่สุด
    - อย่ายกตัวอย่างสมมติที่ไม่มีอยู่ในข้อมูล
    - หากคำถามหรือข้อความของผู้ใช้มีความไม่พอใจ เช่น "บริการไม่ดี", "แย่มาก", "ตอบช้า" ให้เริ่มต้นด้วย "ขออภัยในความไม่สะดวกครับ ขอบคุณสำหรับคำแนะนำและคำติชม เรายินดีนำไปปรับปรุงเพื่อพัฒนาการบริการให้ดียิ่งขึ้นครับ" และไม่ต้องตอบอะไรเพิ่มเติม
    ...
    โปรดให้คำแนะนำในการสร้างคำถามที่เหมาะสมและเอาคำตอบเป็นประโยคที่สมบูรณ์ครบถ้วนพร้อมให้คำแนะนำในการตอบและเสนอแนะ
    และ ถ้าเป็นการขอบคุณ ก็ให้แนะนำวิธีการขอบคุณ 
    """)
...
def summarize_answer(question, context_p, previous_context):
    ...
    **คำแนะนำที่ต้องทำในการตอบกลับ**:
    - ทำการคัดกรองข้อมูลที่สำคัญจาก {context} 
    - คัดกรองคำตอบที่กระชับ ชัดเจนเข้าใจง่ายและไม่ยาวเกินไป
    - เอาคำตอบเดียวที่ชัดเจนไม่เว้นวรรค
    - ถ้าไม่มีข้อมูลให้ตอบว่า "ขออภัยครับ ขณะนี้ทางบอทของเรายังไม่สามารถตอบคำถามนี้ได้ หรือลองพิมพ์คำถามใหม่อย่างละเอียดกับทางบอทเพื่อให้เราสามารถช่วยตอบคำถามได้ดียิ่งขึ้นครับ"
    - เลือกข้อมูลที่ตรงประเด็นและสามารถให้คำตอบที่ชัดเจน
    - **เน้นยำ**หากคำถามหรือข้อความของผู้ใช้มีความไม่พอใจ ได้แก่ "บริการไม่ดี", "แย่มาก", "ตอบช้า" ให้เริ่มต้นด้วย "ขออภัยในความไม่สะดวกครับ ขอบคุณสำหรับคำแนะนำและคำติชม เรายินดีนำไปปรับปรุงเพื่อพัฒนาการบริการให้ดียิ่งขึ้นครับ"

    **เงื่อนไขสำคัญสำหรับกรณีผู้ใช้ "ขอบคุณ" หรือแจ้งว่า "ได้แล้ว", "ขอบคุณครับ", "ขอบคุณค่ะ", "เรียบร้อยแล้วครับ", "ใช้งานได้แล้วครับ" หรือข้อความลักษณะคล้ายกันที่อยู่ในรูปเชิงขอบคุณ**:
...
def base_system(question, context_p, emotional_p, is_first_turn: bool):
    ...
    โปรดวิเคราะห์ข้อมูลของผู้สนทนาเท่าที่มีอยู่ในข้อความอย่างสุภาพและรอบคอบและให้ตอบเหมือนอยู่ในฐานะเจ้าหน้าที่คุยกับคน
    พร้อมมีการเรียบเรียงคำให้สวยงามและห้ามใช้สัญลักษณ์พิเศษและต้องตอบแบบสุภาพทางการ
    ...
    **เน้นยำ**ให้ตอบตามอารมณ์ของผู้ถามตามความเหมาะสม: "{emotional}"
    ...
    **คำแนะนำในการตอบคำถาม**:
    - ให้ตอบชัดเจนอย่าวนคำซ้ำ
    - อธิบายและตอบให้กระชับสั้น เข้าใจง่าย และหลีกเลี่ยงคำตอบที่ยาวเกินไป
    ...
    **เงื่อนไขเพิ่มเติม**:
    ...
    โปรดตอบคำถามให้ได้ตรงประเด็น ไม่แต่งเติมหรือปรุงแต่งคำเองและตอบเหมือนคุยกับคน
    """)
