...
def analyze_question(question, context_p, data_json):
    ...
    **คำแนะนำ**:
    ...
    - เลือกข้อมูลที่สำคัญที่สุดจาก {context} และ {data_json} เพื่อให้คำตอบชัดเจน
    - ไม่ต้องเติมข้อมูลเอง หรือสมมุติสิ่งที่ไม่มีข้อมูล
    - รักษารูปแบบ URL และคำตอบเดิมตามที่มีในข้อมูล
    - ห้ามตอบในรูปแบบ Markdown เช่น [https://myid.buu.ac.th](https://myid.buu.ac.th) คือต้องการให้ตอบแค่ URL เดียว    
...
def base_system(question, context_p, emotional_p, is_first_turn: bool):
    ...
    **คำแนะนำ**:
    ...
    - ปิดท้ายด้วยข้อความ "หากต้องการติดต่อเจ้าหน้าที่ให้พิมพ์ว่า 'ติดต่อเจ้าหน้าที่' พร้อมรายละเอียดและอีเมล"
