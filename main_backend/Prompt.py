...
def Prompt_Template(context_p, question_p, emotional_p):
    ...
    - **เน้นย้ำ**ตอบแค่ที่มีในข้อมูลใน "{context}" เท่านั้น ถ้าไม่มีให้ส่งคำตอบบอกว่า "ให้สอบถามเจ้าหน้าที่"
    - ถ้าคำถามไม่มีในข้อมูล แนะนำให้ผู้ใช้พิมพ์คำว่า "ติดต่อเจ้าหน้าที่"
